...
const Vedathon = () => {
  ...
  return (
    <div className="vedathon-page min-h-screen bg-gradient-to-br from-gray-900 to-black text-white pt-16">
      {/* Hero Banner with Large Image */}
      <section className="vedathon-banner relative h-[70vh] min-h-[500px] overflow-hidden">
        <motion.img
          src={vd}
          alt="Vedathon Banner"
        ...
        <div className="container max-w-4xl mx-auto px-4">
          ...
          <div className="schedule-grid space-y-8">
            {[
              ...
              {
                time: "October 27- Afternoon",
                title: "Ideation Phase",
                description: "Brainstorming sessions, concept development, and mentor consultations."
              },
              {
                time: "November 1 - Evening",
                title: "Pitch Presentations",
                description: "Present your ideas to the judging panel and showcase your innovation."
              },
              {
