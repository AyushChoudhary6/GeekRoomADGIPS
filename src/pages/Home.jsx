...
const Home = () => {
  ...
  return (
    <div className="pt-16 bg-gradient-to-br from-gray-900 to-black">
      ...
      <section className="section-padding bg-gradient-to-b from-gray-900 to-green-900/30">
        <div className="container-custom">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-transparent">
      ...
      <section className="section-padding bg-green-900/20">
        <div className="container-custom">
          <motion.div
            className="glass-card p-8 md:p-12 max-w-6xl mx-auto border border-green-500/20 bg-gray-800/50"
          ...
          >
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              <div className="flex-1">
                <span className="inline-block bg-gradient-to-r from-green-500 to-green-600 text-white px-4 py-2 rounded-full text-sm font-bold mb-4">
                  Upcoming Event
                </span>
                ...
                >
                  <Link
                    to="/events"
                    className="inline-block bg-gradient-to-r from-green-500 to-green-600 text-white px-6 py-3 rounded-lg font-semibold"
                  >
                    View All Events
                  </Link>
                </motion.div>
              ...
              <div className="flex-shrink-0">
                <motion.div
                  ...
                  variants={cardHoverVariants}
                >
                  <div className="w-80 h-64 rounded-xl border border-green-500/30 overflow-hidden shadow-2xl">
                    <img
                      src={vedathonImage}
